...
import com.example.lab4gagan.R;
...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MyRowHolder> {
    ...
    public MyRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {  // Sent message
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.send_mess, parent, false);
        } else {  // Received message
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.receeve_mes, parent, false);
        }
